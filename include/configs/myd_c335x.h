/*
 * Config file for MYIR Tech MYD_C335X board
 *
...
#ifndef __CONFIG_MYD_C335X_H
#define __CONFIG_MYD_C335X_H
...
#define MACH_TYPE_MYD_C335X		4589	/* Until the next sync */
...
#define NANDARGS \
	"updatesys=nand erase.chip;mmc dev 0; mmc rescan; " \
		...
		"fatload mmc 0 0x82000000 myd_c335x.dtb; 	nand write 0x82000000 0x80000 ${filesize};" \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"findfdt="\
		...
		"if test $board_name = myd_c335x; then " \
			"setenv fdtfile myd_c335x.dtb; fi; " \
