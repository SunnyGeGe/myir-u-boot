/*
 * Config file for MYIR Tech MYD_J335X board
 *
...
#define GPIO_PHY_RST2		GPIO_PIN(3, 7)
...
#define MACH_TYPE_MYD_J335X		3589	/* Until the next sync */
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"findfdt="\
		...
		"if test $board_name = myd_j335x; then " \
			"setenv fdtfile myd_j335x.dtb; fi; " \
