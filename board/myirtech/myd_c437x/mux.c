/*
 * mux configuration code for MYIR Tech MYD-C437X board
 *
...
static struct module_pin_mux gpio3_pin_mux[] = 
{
	...
	{OFFSET(emu1), (MODE(7) | PULLUP_EN)},	/* GPIO3_8 for EMMC-RST */
	{-1},
};


static struct module_pin_mux gpio4_pin_mux[] = 
{
	{OFFSET(cam1_data8), (MODE(7) | PULLUDDIS | RXACTIVE)},	/* GPIO4_8 for WDT */
	{-1},
};

static struct module_pin_mux gpio5_pin_mux[] = {
	{OFFSET(gpio5_11), (MODE(7) | PULLUP_EN)},	/* GPIO5_11 for CPU_LED */
	{-1},
};
...
void set_mux_conf_regs(void)
{
	...
	if (board_is_myd_c437x_idk()) {
		...
		configure_module_pin_mux(gpio4_pin_mux);
		configure_module_pin_mux(gpio5_pin_mux);
