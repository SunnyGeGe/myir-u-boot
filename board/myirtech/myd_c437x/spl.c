/*
 * SPL specific code for MYIR Tech MYD-C437X board
 *
...
const struct dpll_params dpll_mpu = {600, 23, 1, -1, -1, -1, -1};
const struct dpll_params dpll_core = {1000, 23, -1, -1, 10, 8, 4};
const struct dpll_params dpll_per = {960, 23, 5, -1, -1, -1, -1};
...
{
	if (board_is_myd_c437x_idk() && !strcmp(name, "myd_c437x"))
	{		
		return 0;
	}
	else
