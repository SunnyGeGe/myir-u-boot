...
/* MYIR EEPROM MAGIC Header identifier */
 ...
 */
int myir_i2c_eeprom_am_get(int bus_addr, int dev_addr);
 ...
 * @dev_addr:	I2C slave address
 */
int myir_i2c_eeprom_dra7_get(int bus_addr, int dev_addr);
 ...
 *	   true otherwise
 */
bool board_myir_is(char *name_tag);
 ...
 *	   true otherwise
 */
bool board_myir_rev_is(char *rev_tag, int cmp_len);
 ...
 */
char *board_myir_get_config(void);
 ...
 */
void board_myir_get_eth_mac_addr(int index, u8 mac_addr[TI_EEPROM_HDR_ETH_ALEN]);
 ...
 */
u64 board_myir_get_emif1_size(void);
 ...
 */
u64 board_myir_get_emif2_size(void);
 ...
 */
int myir_i2c_eeprom_am_set(const char *name, const char *rev);
