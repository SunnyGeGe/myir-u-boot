/*
 * Library to support early MYIR EVM EEPROM handling
 *
 ...
 */
static int __maybe_unused myir_i2c_eeprom_init(int i2c_bus, int dev_addr)
{
	int rc;
 ...
 */
static int __maybe_unused myir_i2c_eeprom_read(int dev_addr, int offset,
					     uchar *ep, int epsize)
{
 ...
 */
static void __maybe_unused myir_eeprom_string_cleanup(char *s)
{
	int i, l;
...
static int __maybe_unused myir_i2c_eeprom_get(int bus_addr, int dev_addr,
...
int __maybe_unused myir_i2c_eeprom_am_set(const char *name, const char *rev)
{
...
int __maybe_unused myir_i2c_eeprom_am_get(int bus_addr, int dev_addr)
{
	int rc;
...
int __maybe_unused myir_i2c_eeprom_dra7_get(int bus_addr, int dev_addr)
{
	int rc, offset = 0;
...
bool __maybe_unused board_myir_is(char *name_tag)
{
...
bool __maybe_unused board_myir_rev_is(char *rev_tag, int cmp_len)
{
	struct ti_common_eeprom *ep = TI_EEPROM_DATA;
	int l;
...
char * __maybe_unused board_myir_get_rev(void)
{
	struct ti_common_eeprom *ep = TI_EEPROM_DATA;
...
char * __maybe_unused board_myir_get_config(void)
{
	struct ti_common_eeprom *ep = TI_EEPROM_DATA;
...
char * __maybe_unused board_myir_get_name(void)
{
	struct ti_common_eeprom *ep = TI_EEPROM_DATA;
...
void __maybe_unused
board_myir_get_eth_mac_addr(int index,
...
u64 __maybe_unused board_myir_get_emif1_size(void)
{
	struct ti_common_eeprom *ep = TI_EEPROM_DATA;
...
u64 __maybe_unused board_myir_get_emif2_size(void)
{
	struct ti_common_eeprom *ep = TI_EEPROM_DATA;
